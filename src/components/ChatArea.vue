          ...
          <div class="flex items-end space-x-3">
            <div class="flex-1 relative">
              <textarea
                ...
                placeholder="输入您的问题..."
                class="w-full resize-none border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-dark-card text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <button
              ...
              :class="[
                ...
                localInputMessage.trim() && !isLoading
